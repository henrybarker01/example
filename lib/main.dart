...
class _MyAppState extends State<MyApp> {
  ...
  final String _clientId = '63f61210-13d2-4b59-bbe7-5c510694d57f';
  final String _redirectUrl = 'io.ionic.qa.kaap.agri.agrimark://oauthredirect'; 
  //final String _issuer = 'https://kaapagrib2c.b2clogin.com/045044bb-a0a1-4d5a-8705-172895422ea3/v2.0/';
  final String _discoveryUrl =
      'https://kaapagrib2c.b2clogin.com/kaapagrib2c.onmicrosoft.com/B2C_1_KaapAgriSignIn/v2.0/.well-known/openid-configuration';
  ...
  final AuthorizationServiceConfiguration _serviceConfiguration =
      const AuthorizationServiceConfiguration(
          'https://kaapagrib2c.b2clogin.com/kaapagrib2c.onmicrosoft.com/b2c_1_kaapagrisignin/oauth2/v2.0/authorize',
          'https://kaapagrib2c.b2clogin.com/kaapagrib2c.onmicrosoft.com/b2c_1_kaapagrisignin/oauth2/v2.0/token');
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Test 123 example app'),
        ),
    ...
    try {
      ...
      final AuthorizationResponse? result = await _appAuth.authorize(
        AuthorizationRequest(_clientId, _redirectUrl,
            discoveryUrl: _discoveryUrl, scopes: _scopes, loginHint: 'henrybarker11+2@gmail.com'),
      );
